...
public class GeradoraDeFigurinhas {
    ...
    public void cria(InputStream inputStream, String nomeArquivo, String texto, InputStream inputStreamSobreposicao) throws Exception {
        ...
        int novaAltura = (int) (altura + (altura * 0.15)); // acrescenta 15% da altura original
        ...
        int posicaoTextoX = (int)((largura - retangulo.getWidth()) / 2);
        int posicaoTextoY = (int)(novaAltura - (novaAltura-altura) + retangulo.getHeight() );
